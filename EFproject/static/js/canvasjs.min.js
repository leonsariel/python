...
*/
(function() {
    function S(a, c) { a.prototype = Pa(c.prototype);
        a.prototype.constructor = a;
        a.base = c.prototype }

    function Pa(a) {
        function c() {} c.prototype = a; return new c }
    ...
    function O(a, c) { var b = !1;
        0 > a && (b = !0, a *= -1);
        a = "" + a; for (c = c ? c : 1; a.length < c;) a = "0" + a; return b ? "-" + a : a }

    function ka(a) { if (!a) return a;
        a = a.replace(/^\s\s*/, ""); for (var c = /\s/, b = a.length; c.test(a.charAt(--b));); return a.slice(0, b + 1) }
    ...
    function F(a) { var c = ((a & 16711680) >> 16).toString(16),
            b = ((a & 65280) >> 8).toString(16);
        a = ((a & 255) >> 0).toString(16);
        c = 2 > c.length ? "0" + c : c;
        b = 2 > b.length ? "0" + b : b;
        a = 2 > a.length ? "0" + a : a; return "#" + c + b + a }
    ...
    function y(a) { return null === a || "undefined" === typeof a }
    ...
    function Ka(a, c, b) {
        ...
        if (isNaN(f)) {
            ...
            } catch (k) { f = Math.ceil(1.1 * c) } f = Math.max(f, c);
            La[d] = f
        }
        return f
    }
    ...
    function J(a, c, b, d) { return a.addEventListener ? (a.addEventListener(c, b, d || !1), b) : a.attachEvent ? (d = function(d) { d = d || window.event;
            d.preventDefault = d.preventDefault || function() { d.returnValue = !1 };
            d.stopPropagation = d.stopPropagation || function() { d.cancelBubble = !0 };
            b.call(a, d) }, a.attachEvent("on" + c, d), d) : !1 }
    ...
    function ra(a, c, b) { if (t && Na) { var d = a.getContext("2d");
            ...
            a.width = c * P;
            a.height = b * P;
            za !== sa && (a.style.width = c + "px", a.style.height = b + "px", d.scale(P, P)) } else a.width = c, a.height = b }
    ...
    function L(a, c, b, d) { this._defaultsKey = a;
        this.parent = d;
        ...
        if (this.container = "string" === typeof this._containerId ? document.getElementById(this._containerId) : this._containerId) {
            ...
            this.canvas.getContext && (this._canvasJSContainer.appendChild(this.canvas), this.ctx = this.canvas.getContext("2d"), this.ctx.textBaseline = "top", Ia(this.ctx), t ? this.plotArea.ctx = this.ctx : (this.plotArea.canvas = fa(d, f), this.plotArea.canvas.style.position = "absolute", this.plotArea.canvas.setAttribute("class", "plotAreaCanvas"), this._canvasJSContainer.appendChild(this.plotArea.canvas),
                ...
                this._toolBar.style.cssText = "position: absolute; right: 1px; top: 1px;", this._canvasJSContainer.appendChild(this._toolBar), this.bounds = { x1: 0, y1: 0, x2: this.width, y2: this.height }, J(this.overlaidCanvas, "click", function(a) { b._mouseEventHandler(a) }), J(this.overlaidCanvas, "mousemove", function(a) { b._mouseEventHandler(a) }), J(this.overlaidCanvas, "mouseup", function(a) { b._mouseEventHandler(a) }), J(this.overlaidCanvas, "mousedown", function(a) { b._mouseEventHandler(a);
                    Z(b._dropdownMenu) }), J(this.overlaidCanvas, "mouseout",
    ...
    function ia(a, c, b, d, f) { "undefined" === typeof f && (f = 0);
        this._padding = f;
        this._x1 = a;
        this._y1 = c;
        this._x2 = b;
    ...
    function U(a, c) { U.base.constructor.call(this, "TextBlock", c);
        this.ctx = a;
        this._isDirty = !0;
    ...
    function ma(a, c) {
        ...
        if (y(this.options.margin) && a.options.subtitles)
            for (var b = a.options.subtitles, d = 0; d < b.length; d++)
                if ((y(b[d].horizontalAlign) && "center" === this.horizontalAlign || b[d].horizontalAlign === this.horizontalAlign) && (y(b[d].verticalAlign) && "top" === this.verticalAlign || b[d].verticalAlign === this.verticalAlign) && !b[d].dockInsidePlotArea === !this.dockInsidePlotArea) { this.margin = 0; break }
        "undefined" === typeof this.options.fontSize && (this.fontSize = this.chart.getAutoFontSize(this.fontSize));
        this.height = this.width = null;
        this.bounds = { x1: null, y1: null, x2: null, y2: null }
    }

    function va(a, c) { va.base.constructor.call(this, "Subtitle", c, a.theme, a);
        this.chart = a;
    ...
    function Q(a, c) { Q.base.constructor.call(this, "ToolTip", c, a.theme, a);
        this.chart = a;
        this.canvas = a.canvas;
        this.ctx = this.chart.ctx;
        ...
        ca = function(a, c, b) {
            ...
            for (var w = 0; k && w < k.length; w++)
                if (c = k[w], "." === c && 0 > h) h = w;
                    ...
                    if ("%" === c) l *= 100;
                    else if ("\u2030" === c) { l *= 1E3; continue } else if ("," === c[0] && "." === c[c.length - 1]) { l /= Math.pow(1E3, c.length - 1);
                        h = w + c.length - 1; continue } else "E" !== c[0] && "e" !== c[0] || "0" !== c[c.length - 1] || (r = !0);
            ...
            for (r = k = w = e = h = 0; 0 < m.length;)
                if (c = m.pop(), "#" === c || "0" === c)
                    if (h++, h === n) { var u = l,
                            l = []; if ("0" === c)
                            for (c = n - e - (u ? u.length : 0); 0 < c;) u.unshift("0"), c--; for (; 0 < u.length;) b = u.pop() + b, r++, 0 === r % k && (w === q && 0 < u.length) && (b = g + b) } else 0 < l.length ? (b = l.pop() + b, e++, r++) :
    ...
    (function() {
        A.fSDec = function(a) { for (var c = "", b = 0; b < a.length; b++) c += String.fromCharCode(Math.ceil(a.length / 57 / 5) ^ a.charCodeAt(b)); return c };
        A.obj = {
            trVs: "Ush`m!Wdsrhno",
        ...
        A.ckDec = function(a) { for (var c = "", b = 0; b < a.length; b++) c += String.fromCharCode(Math.ceil(a.length / 57 / 5) ^ a.charCodeAt(b)); return c };
        A.obj.ckn = "^^bvkVrUs";
            ...
            if (!Aa) try {
                ...
                a: {
                    ...
                    if (f && 0 < f.length || g) {
                        ...
                        if (isNaN(r) || p > r) { c = !0; break a }
                    } else { k = new Date;
                        h = k.getTime();
                        k.setTime(h + 31536E6); var s = { name: A.ckDec(A.obj.ckn), val: (new Date).getTime() };
                        document.cookie = A.ckDec(A.obj.ckn) + "=" + (new Date).getTime() + "; " + A.ckDec(A.obj.ckve) + k.toUTCString() + "; path=/;";
                        localStorage.setItem("lclStg", JSON.stringify(s)) } c = !1
                }
                if (c) {
                    c = 24;
    ...
    L.prototype.setOptions = function(a, c) { if (ba[this._defaultsKey]) { var b = ba[this._defaultsKey],
                d; for (d in b) "publicProperties" !== d && b.hasOwnProperty(d) && (this[d] = a && d in a ? a[d] : c && d in c ? c[d] : b[d]) } };
    ...
    L.prototype.set = function(a, c, b) {
        ...
        else { window.console && (d.publicProperties && d.publicProperties.hasOwnProperty(a) && "readOnly" === d.publicProperties[a] ? window.console.log('Property "' + a + '" is read-only.') : window.console.log('Property "' + a + "\" doesn't exist. Please check for typo.")); return } b && (this.chart || this).render()
    };
    ...
    L.prototype.createUserOptions = function(a) {
        if ("undefined" !== typeof a || this.options._isPlaceholder)
            if (this.parent.options._isPlaceholder && this.parent.createUserOptions(), this.isOptionsInArray) { this.parent.options[this.optionsName] || (this.parent.options[this.optionsName] = []); var c = this.parent.options[this.optionsName],
                    b = c.length;
                this.options._isPlaceholder || (qa(c), b = c.indexOf(this.options));
                this.options = "undefined" === typeof a ? {} : a;
                c[b] = this.options } else this.options = "undefined" === typeof a ? {} : a, a = this.parent.options,
    ...
    L.prototype.remove = function(a) { a = "undefined" === typeof a ? !0 : a; if (this.isOptionsInArray) { var c = this.parent.options[this.optionsName];
            qa(c); var b = c.indexOf(this.options);
            0 <= b && c.splice(b, 1) } else delete this.parent.options[this.optionsName];
    ...
    B.prototype._updateOptions = function() {
        ...
        this.options.zoomEnabled ? (this._zoomButton || (Z(this._zoomButton = document.createElement("button")),
            R(this, this._zoomButton, "pan"), this._toolBar.appendChild(this._zoomButton), J(this._zoomButton, "click", function() { a.zoomEnabled ? (a.zoomEnabled = !1, a.panEnabled = !0, R(a, a._zoomButton, "zoom")) : (a.zoomEnabled = !0, a.panEnabled = !1, R(a, a._zoomButton, "pan"));
                a.render() })), this._resetButton || (Z(this._resetButton = document.createElement("button")), R(this, this._resetButton, "reset"), this._toolBar.appendChild(this._resetButton), J(this._resetButton, "click", function() {
            a.toolTip.hide();
        ...
        if (!this._dropdownMenu && this.exportEnabled && t) {
            ...
            J(c, "mouseover", function() { this.style.backgroundColor = "#EEEEEE" }, !0);
            J(c, "mouseout", function() { this.style.backgroundColor = "transparent" }, !0);
            J(c, "click", function() { Ba(a.canvas, "jpeg", a.exportFileName);
                Z(a._dropdownMenu) }, !0);
            c = document.createElement("div");
            c.style.cssText = "padding: 2px 15px 2px 10px";
            ...
            J(c, "click", function() { Ba(a.canvas, "png", a.exportFileName);
                Z(a._dropdownMenu) }, !0)
        }
    ...
    B.prototype._updateSize = function() { var a = 0,
            c = 0;
        this.options.width ? a = this.width : this.width = a = 0 < this.container.clientWidth ? this.container.clientWidth : this.width;
        this.options.height ? c = this.height : this.height = c = 0 < this.container.clientHeight ? this.container.clientHeight : this.height; return this.canvas.width !== a * P || this.canvas.height !== c * P ? (ra(this.canvas, a, c), ra(this.overlaidCanvas, a, c), ra(this._eventManager.ghostCanvas, a, c), !0) : !1 };
    B.prototype._initialize = function() {
        ...
        var g = this;
        this.addEventListener("dataAnimationIterationEnd", function() { A.fSWm && A.fSWm(g);
    ...
    B.prototype.render = function(a) {
        ...
        var d = [];
        if (this.animatedRender) { var f = fa(this.width, this.height);
        ...
        }, function() { d = []; for (var a = 0; a < p.plotInfo.plotTypes.length; a++)
        ...
        for (var a = "", c = 0; c < this.data.length; c++)
            if (a = this.data[c], a.dataPoints && (0 !== a.dataPoints.length && a.visible) && 0 <= B._supportedChartTypes.indexOf(a.type)) {
                for (var b = null, d = !1,
                    ...
                    if (this.plotInfo.plotTypes[l].type === a.type) { d = !0;
                        b = this.plotInfo.plotTypes[l]; break }
                d || (b = { type: a.type, totalDataSeries: 0, plotUnits: [] }, this.plotInfo.plotTypes.push(b));
                for (l = 0; l < b.plotUnits.length; l++)
                    if (b.plotUnits[l].axisYType === a.axisYType && b.plotUnits[l].axisXType === a.axisXType && b.plotUnits[l].axisYIndex === a.axisYIndex && b.plotUnits[l].axisXIndex === a.axisXIndex) { g = !0;
                        f = b.plotUnits[l]; break }
                g || (f = {
                    type: a.type,
    ...
    B.prototype.assignIdToDataPoints = function() { for (var a = 0; a < this.data.length; a++) { var c = this.data[a]; if (c.dataPoints)
        ...
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
            for (var c = a.axisY.dataInfo, b = a.axisX.dataInfo, d, f, g = !1, l = 0; l < a.dataSeriesIndexes.length; l++) {
                ...
                for (h = 0; h < k.dataPoints.length; h++) {
                    ...
                    if (0 < h) { if (a.axisX.logarithmic) { var r = d / k.dataPoints[h - 1].x;
                            1 > r && (r = 1 / r);
                            b.minDiff > r && 1 !== r && (b.minDiff = r) } else r = d - k.dataPoints[h - 1].x, 0 > r && (r *= -1), b.minDiff > r && 0 !== r && (b.minDiff = r);
        ...
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
            for (var c =
                ...
                for (e = 0; e < n.dataPoints.length; e++) {
                    ...
                    d > b.max && (b.max = d);
                    if (0 < e) {
                        if (a.axisX.logarithmic) { var v = d / n.dataPoints[e - 1].x;
                            1 > v && (v = 1 / v);
                            b.minDiff > v && 1 !== v && (b.minDiff = v) } else v = d - n.dataPoints[e - 1].x, 0 > v && (v *= -1), b.minDiff > v && 0 !== v && (b.minDiff = v);
                    ...
                    else { if (!q && (q = !0, 0 < e)) { e -= 2; continue } if (d > u && !r) r = !0;
            ...
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                for (var c = a.axisY.dataInfo, b = a.axisX.dataInfo, d, f, g = !1, l = !1, k = !1, h = [], m = 0; m < a.dataSeriesIndexes.length; m++) {
                    ...
                    for (n = 0; n < p.dataPoints.length; n++) {
                        ...
                        d > b.max && (b.max = d);
                        if (0 < n) {
                            if (a.axisX.logarithmic) { var u = d / p.dataPoints[n - 1].x;
                                1 > u && (u = 1 / u);
                                b.minDiff > u && 1 !== u && (b.minDiff = u) } else u = d - p.dataPoints[n - 1].x, 0 > u && (u *= -1), b.minDiff > u && 0 !== u && (b.minDiff = u);
                        ...
                        if (d < s && !e) null !== f && (r = d);
                        else { if (!e && (e = !0, 0 < n)) { n -= 2; continue } if (d > w && !q) q = !0;
        ...
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
            for (var c = a.axisY.dataInfo, b = a.axisX.dataInfo, d, f, g, l, k = !1, h = 0; h < a.dataSeriesIndexes.length; h++) {
                ...
                for (p = 0; p < m.dataPoints.length; p++) {
                    ...
                    if ((f = m.dataPoints[p].y) && f.length) { g = Math.min.apply(null, f);
                        l = Math.max.apply(null, f);
                        r = !0; for (var v = 0; v < f.length; v++) null === f.k && (r = !1);
                        r && (n || (s = q), q = d) } d < b.min && (b.min = d);
                    d > b.max && (b.max = d);
                    g < c.min && (c.min = g);
                    l > c.max && (c.max = l);
                    ...
                    if (!(d < w) || n) {
                        ...
                        if (b.viewPortMin === d && f)
                            for (v = 0; v < f.length; v++)
                                if (null === f[v] && q < d) { b.viewPortMin = q; break }
    ...
    B.prototype.getObjectAtXY =
        function(a, c, b) { var d = null; if (b = this.getDataPointAtXY(a, c, b || !1)) d = b.dataSeries.dataPointIds[b.dataPointIndex];
            else if (t) d = Ma(a, c, this._eventManager.ghostCtx);
            else
                for (b = 0; b < this.legend.items.length; b++) { var f = this.legend.items[b];
    ...
    B.prototype.clearCanvas = function() { this.ctx.clearRect(0, 0, this.width, this.height);
    ...
    B.prototype._touchEventHandler = function(a) {
        if (a.changedTouches && this.interactivityEnabled) {
            ...
            if (!(b && 1 < b.length)) {
                f = xa(d);
                f.time = new Date;
                try { var g = f.y - this._lastTouchData.y; if (15 < Math.abs(g) && this._lastTouchData.scroll) { this._lastTouchData.scroll = !0; var l = window.parent || window;
                        l && l.scrollBy && l.scrollBy(0, -g) } } catch (k) {} this._lastTouchEventType =
                    a.type;
    ...
    B.prototype._plotAreaMouseDown = function(a, c) { this.isDrag = !0;
    ...
    B.prototype._zoomPanToSelectedRegion = function(a, c, b, d, f) { a = this.validateRegion(a, c, b, d, f);
        c = a.axesWithValidRange;
        b = a.axesRanges; if (a.isValid)
            for (d = 0; d < c.length; d++) f = b[d], c[d].setViewPortRange(f.val1, f.val2); return a.isValid };
    ...
    B.prototype.preparePlotArea = function() {
        ...
        if ((this.axisX[0] || this.axisX2[0]) && (this.axisY[0] || this.axisY2[0])) {
            ...
            if (this.axisY && 0 < this.axisY.length && this.axisY[0]) { var b = this.axisY[0];
                ...
                a.width = a.x2 - a.x1;
                a.height = a.y2 - a.y1 } this.axisY2 && 0 < this.axisY2.length && this.axisY2[0] && (b = this.axisY2[0], a.x1 = c.x1 < c.x2 ? c.x1 : b.lineCoordinates.x1, a.y1 = c.y1 < b.lineCoordinates.y1 ?
    ...
    B.prototype.renderIndexLabels =
        function(a) {
            ...
            for (a = 0; a < this._indexLabels.length; a++) {
                ...
                if (m.dataSeries.indexLabelFormatter || m.dataPoint.indexLabelFormatter) v = { chart: this, dataSeries: m.dataSeries, dataPoint: m.dataPoint, index: m.indexKeyword, total: u.total, percent: u.percent };
    ...
    B.prototype.renderLine = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var d = [], f, g = 0; g < a.dataSeriesIndexes.length; g++) {
                ...
                var h = k.dataPoints,
                    m = "solid";
                if (c.setLineDash) { var p = G(k.nullDataLineDashType, k.lineThickness),
                        m = k.lineDashType,
                    ...
                    for (var v = !1, s = 0; s < h.length; s++)
                        if (w = h[s].x.getTime ? h[s].x.getTime() : h[s].x, !(w < a.axisX.dataInfo.viewPortMin || w > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !v)))
                            if ("number" !== typeof h[s].y) 0 < s && !(k.connectNullData || v || r) && (c.stroke(), t && b.stroke()), v = !0;
                                ...
                                this._eventManager.objectMap[z] = { id: z, objectType: "dataPoint", dataSeriesIndex: l, dataPointIndex: s, x1: w, y1: u };
                    ...
                    for (var v = !1, s = 0; s < h.length; s++)
                        if (w = h[s].getTime ? h[s].x.getTime() : h[s].x, !(w < a.axisX.dataInfo.viewPortMin || w > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !v)))
                            if ("number" !== typeof h[s].y) 0 <
                                ...
                                if (0 < h[s].markerSize || 0 < k.markerSize) z = k.getMarkerProperties(s, w, u, c), d.push(z), x = F(x), t && d.push({ x: w, y: u, ctx: b, type: z.type, size: z.size, color: x, borderColor: x, borderThickness: z.borderThickness });
    ...
    B.prototype.renderSpline = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var f = [], g = 0; g < a.dataSeriesIndexes.length; g++) {
                ...
                var h = k.dataPoints,
                    m = "solid";
                if (b.setLineDash) { var p = G(k.nullDataLineDashType, k.lineThickness),
                        m = k.lineDashType,
                        n = G(m, k.lineThickness);
                    b.setLineDash(n) }
                var e = k.id;
                    ...
                    for (w = !1, r = 0; r < h.length; r++)
                        if (s = h[r].getTime ? h[r].x.getTime() : h[r].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !w)))
                            if ("number" !== typeof h[r].y) 0 < r && !w && (k.connectNullData ? b.setLineDash && (0 < u.length && (k.options.nullDataLineDashType ||
                                ...
                                this._eventManager.objectMap[v] = { id: v, objectType: "dataPoint", dataSeriesIndex: l, dataPointIndex: r, x1: s, y1: w };
                                u[u.length] = { x: s, y: w };
                                ...
                                if (0 < h[r].markerSize || 0 < k.markerSize) { var z = k.getMarkerProperties(r, s, w, b);
                                    f.push(z);
                                    v = F(v);
                                    t && f.push({ x: s, y: w, ctx: d, type: z.type, size: z.size, color: v, borderColor: v, borderThickness: z.borderThickness }) }(h[r].indexLabel || k.indexLabel || h[r].indexLabelFormatter || k.indexLabelFormatter) && this._indexLabels.push({
                                    chartType: "spline",
                                    dataPoint: h[r],
                                    dataSeries: k,
                                    point: { x: s, y: w },
                ...
                if (0 < r.length) {
                    ...
                    for (k = 0; k < r.length; k++)
                        if (b = r[k].x.getTime ? r[k].x.getTime() : r[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[k].y) {
                            ...
                            else if (h = a.axisY.convertValueToPixel(r[k].y), 0 <= r[k].y) { var z = f[b] ? f[b] : 0;
                                h -= z;
                                v = m - z;
                                f[b] = z + (v - h) } else z = g[b] ? g[b] : 0, v = h + z, h = m + z, g[b] = z + (v - h);
                            ...
                            (r[k].indexLabel || q.indexLabel || r[k].indexLabelFormatter || q.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedColumn", dataPoint: r[k], dataSeries: q, point: { x: d, y: 0 <= r[k].y ? h : v }, direction: 0 > r[k].y === a.axisY.reversed ? 1 : -1, bounds: { x1: w, y1: Math.min(h, v), x2: u, y2: Math.max(h, v) }, color: b })
                        }
                }
            }
            c.restore();
                    ...
                    for (var s = 5 < n && q.bevelEnabled ? !0 : !1, k = 0; k < r.length; k++)
                        if (b = r[k].x.getTime ? r[k].x.getTime() : r[k].x, !(b < a.axisX.dataInfo.viewPortMin ||
                            ...
                            if (a.axisY.logarithmic) { l[b] = h + (l[b] ? l[b] : 0); if (0 >= l[b]) continue;
                                ...
                                v = f[b] ? f[b] : m;
                                f[b] = h } else if (h = a.axisY.convertValueToPixel(h), 0 <= r[k].y) { var z = f[b] ? f[b] : 0;
                                h -= z;
                                v = m - z;
                                f[b] = z + (v - h) } else z = g[b] ? g[b] : 0, v = h + z, h = m + z, g[b] = z + (v - h);
                            ...
                            M(c, w, h, u, v, b, 0, null, s && 0 <= r[k].y, 0 > r[k].y && s, !1, !1, q.fillOpacity);
                            b = q.dataPointIds[k];
                            this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: e, dataPointIndex: k, x1: w, y1: h, x2: u, y2: v };
                            b = F(b);
                            t && M(this._eventManager.ghostCtx, w, h, u, v, b, 0, null, !1, !1, !1, !1);
                            (r[k].indexLabel || q.indexLabel || r[k].indexLabelFormatter || q.indexLabelFormatter) && this._indexLabels.push({
                                ...
                                dataPoint: r[k],
                                dataSeries: q,
                                point: { x: d, y: 0 <= r[k].y ? h : v },
                                direction: 0 >
                                    r[k].y === a.axisY.reversed ? 1 : -1,
                                bounds: { x1: w, y1: Math.min(h, v), x2: u, y2: Math.max(h, v) },
                                color: b
                            })
                        }
            }
                    ...
                    for (k = 0; k < r.length; k++)
                        if (b = r[k].x.getTime ? r[k].x.getTime() : r[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[k].y) {
                            ...
                            if (a.axisY.logarithmic) l[b] = r[k].y + (l[b] ? l[b] : 0), 0 < l[b] && (v = f[b] ? f[b] : m, f[b] = h = a.axisY.convertValueToPixel(l[b]));
                                ...
                                v = m + z;
                                h += z;
                                f[b] = z + (h - v) } else z = g[b] ? g[b] : 0, v = h - z, h = m - z, g[b] = z + (h - v);
                            b = r[k].color ? r[k].color : q._colorSet[k % q._colorSet.length];
                            ...
                            (r[k].indexLabel || q.indexLabel || r[k].indexLabelFormatter || q.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedBar", dataPoint: r[k], dataSeries: q, point: { x: 0 <= r[k].y ? h : v, y: d }, direction: 0 > r[k].y === a.axisY.reversed ? 1 : -1, bounds: { x1: Math.min(v, h), y1: w, x2: Math.max(v, h), y2: u }, color: b })
                        }
                }
            }
            c.restore();
                    ...
                    for (k = 0; k < r.length; k++)
                        if (b = r[k].x.getTime ? r[k].x.getTime() : r[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[k].y) {
                            ...
                            var u = d - a.plotType.plotUnits.length * n / 2 + a.index * n << 0,
                                v = u + n << 0;
                            if (a.axisY.logarithmic) { l[b] = w + (l[b] ? l[b] : 0); if (0 >= l[b]) continue;
                                w = f[b] ? f[b] : m;
                                f[b] = h = a.axisY.convertValueToPixel(l[b]) } else if (h = a.axisY.convertValueToPixel(w), 0 <= r[k].y) {
                                var z =
                                    f[b] ? f[b] : 0;
                                w = m + z;
                                h += z;
                            ...
                            b = q.dataPointIds[k];
                            this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: e, dataPointIndex: k, x1: w, y1: u, x2: h, y2: v };
                            b = F(b);
                            ...
                            (r[k].indexLabel || q.indexLabel || r[k].indexLabelFormatter || q.indexLabelFormatter) && this._indexLabels.push({
                                ...
                                bounds: { x1: Math.min(w, h), y1: u, x2: Math.max(w, h), y2: v },
                                color: b
                            })
                        }
                }
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (m = 0; m < a.dataSeriesIndexes.length; m++) {
                ...
                if (0 < q.length) {
                    ...
                    b = "solid";
                    if (f.setLineDash) { var C = G(e.nullDataLineDashType, e.lineThickness);
                        b = e.lineDashType; var V = G(b, e.lineThickness);
                        f.setLineDash(V) }
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (k = 0; k < a.dataSeriesIndexes.length; k++) {
                ...
                if (0 < p.length) {
                    ...
                    var y = "solid";
                    if (b.setLineDash) { var A = G(m.nullDataLineDashType, m.lineThickness),
                            y = m.lineDashType,
                    ...
                    for (q = !1; n < p.length; n++)
                        if (e = p[n].x.getTime ? p[n].x.getTime() : p[n].x, !(e < a.axisX.dataInfo.viewPortMin || e > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !q)))
                            if ("number" !== typeof p[n].y) 0 < n && !q && (m.connectNullData ? b.setLineDash && (0 < u.length && (m.options.nullDataLineDashType || !p[n - 1].lineDashType)) && (u[u.length - 1].newLineDashArray = A,
                                ...
                                if (0 !== p[n].markerSize && (0 < p[n].markerSize || 0 < m.markerSize)) { var V = m.getMarkerProperties(n, e, q, b);
                                    l.push(V);
                                    C = F(C);
    ...
    B.prototype.renderStackedArea = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            d = [];
            for (g = 0; g < a.dataSeriesIndexes.length; g++) { var z = a.dataSeriesIndexes[g],
                    x = this.data[z],
                    y = x.dataPoints;
                x.dataPointIndexes = []; for (p = 0; p < y.length; p++) z = y[p].x.getTime ? y[p].x.getTime() : y[p].x, x.dataPointIndexes[z] = p, d[z] || (h.push(z), d[z] = !0);
                h.sort(ya) }
            for (g = 0; g < a.dataSeriesIndexes.length; g++) {
                ...
                k = [];
                p = x.id;
                this._eventManager.objectMap[p] = { objectType: "dataSeries", dataSeriesIndex: z };
                p = F(p);
                s.fillStyle =
                    p;
                if (0 < h.length) {
                    ...
                    v = "solid";
                    if (b.setLineDash) { var C = G(x.nullDataLineDashType, x.lineThickness);
                        v = x.lineDashType; var V = G(v, x.lineThickness);
                        b.setLineDash(V) }
                    for (var W = !0, p = 0; p < h.length; p++) {
                        q = h[p];
                        var I = null,
                            I = 0 <= x.dataPointIndexes[q] ? y[x.dataPointIndexes[q]] : { x: q, y: null };
                        if (!(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!x.connectNullData || !W)))
                            if ("number" !== typeof I.y) x.connectNullData ||
                                ...
                                var da = l[q] ? l[q] : 0;
                                if (a.axisY.logarithmic) { m[q] = I.y + (m[q] ? m[q] : 0); if (0 >= m[q]) continue;
                                    e = a.axisY.convertValueToPixel(m[q]) } else e = a.axisY.convertValueToPixel(I.y), e -= da;
                                k.push({ x: n, y: r - da });
                                l[q] = r - e;
                                ...
                                w = { x: n, y: e };
                                p < y.length - 1 && (B !== (y[p].lineColor || A) || v !== (y[p].lineDashType || x.lineDashType)) && (c(), b.beginPath(), b.moveTo(n, e), k.push({ x: n, y: r - da }), B = y[p].lineColor || A, b.strokeStyle = B, b.setLineDash && (y[p].lineDashType ? (v = y[p].lineDashType, b.setLineDash(G(v, x.lineThickness))) : (v = x.lineDashType, b.setLineDash(V))));
                                if (0 <= x.dataPointIndexes[q]) { var ea = x.dataPointIds[x.dataPointIndexes[q]];
                                    this._eventManager.objectMap[ea] = { id: ea, objectType: "dataPoint", dataSeriesIndex: z, dataPointIndex: x.dataPointIndexes[q], x1: n, y1: e } } 0 <= x.dataPointIndexes[q] && 0 !== I.markerSize && (0 < I.markerSize || 0 < x.markerSize) && (q = x.getMarkerProperties(x.dataPointIndexes[q], n, e, b), f.push(q), markerColor = F(ea), t && f.push({ x: n, y: e, ctx: s, type: q.type, size: q.size, color: markerColor, borderColor: markerColor, borderThickness: q.borderThickness }));
                                (I.indexLabel ||
    ...
    B.prototype.renderStackedArea100 = function(a) {
        function c() {
            for (0 < x.lineThickness &&
                b.stroke(); 0 < k.length;) { var a = k.pop();
                b.lineTo(a.x, a.y);
                t && v.lineTo(a.x, a.y) } b.closePath();
            b.globalAlpha = x.fillOpacity;
            b.fill();
            b.globalAlpha = 1;
            b.beginPath();
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            d = [];
            for (f = 0; f < a.dataSeriesIndexes.length; f++) { var z = a.dataSeriesIndexes[f],
                    x = this.data[z],
                    y = x.dataPoints;
                x.dataPointIndexes = []; for (p = 0; p < y.length; p++) z = y[p].x.getTime ? y[p].x.getTime() : y[p].x, x.dataPointIndexes[z] = p, d[z] || (h.push(z), d[z] = !0);
                h.sort(ya) }
            for (f = 0; f < a.dataSeriesIndexes.length; f++) {
                ...
                if (0 < h.length) {
                    ...
                    w = "solid";
                    if (b.setLineDash) { var C = G(x.nullDataLineDashType, x.lineThickness);
                        w = x.lineDashType; var V = G(w, x.lineThickness);
                        b.setLineDash(V) }
                    for (var W = !0, p = 0; p < h.length; p++) {
                        q = h[p];
                        var I = null,
                        ...
                        if (!(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax &&
                            ...
                            if ("number" !== typeof I.y) x.connectNullData || (W || s) || c(), W = !0;
                                ...
                                n = a.axisX.convertValueToPixel(q);
                                var ea = l[q] ? l[q] : 0;
                                if (a.axisY.logarithmic) { m[q] = da + (m[q] ? m[q] : 0); if (0 >= m[q]) continue;
                                    e = a.axisY.convertValueToPixel(m[q]) } else e = a.axisY.convertValueToPixel(da), e -= ea;
                                k.push({ x: n, y: u - ea });
                                l[q] = u - e;
                                s || W ? (!s && x.connectNullData ? (b.setLineDash && (x.options.nullDataLineDashType || w === x.lineDashType && x.lineDashType !==
                                    x.nullDataLineDashType) && (s = k.pop(), w = k[k.length - 1], c(), b.moveTo(r.x, r.y), k.push(w), k.push(s), w = x.nullDataLineDashType, b.setLineDash(C)), b.lineTo(n, e), t && v.lineTo(n, e)) : (b.beginPath(), b.moveTo(n, e), t && (v.beginPath(), v.moveTo(n, e))), W = s = !1) : (b.lineTo(n, e), t && v.lineTo(n, e), 0 == p % 250 && (c(), b.moveTo(n, e), t && v.moveTo(n, e), k.push({ x: n, y: u - ea })));
                                r = { x: n, y: e };
                                p < y.length - 1 && (B !== (y[p].lineColor || A) || w !== (y[p].lineDashType || x.lineDashType)) && (c(), b.beginPath(), b.moveTo(n, e), k.push({ x: n, y: u - ea }), B = y[p].lineColor ||
                                ...
                                if (0 <= x.dataPointIndexes[q]) { var Fa = x.dataPointIds[x.dataPointIndexes[q]];
                                    this._eventManager.objectMap[Fa] = { id: Fa, objectType: "dataPoint", dataSeriesIndex: z, dataPointIndex: x.dataPointIndexes[q], x1: n, y1: e } } 0 <= x.dataPointIndexes[q] && 0 !== I.markerSize && (0 < I.markerSize || 0 < x.markerSize) && (q = x.getMarkerProperties(p, n, e, b), g.push(q), markerColor = F(Fa), t && g.push({
                                    x: n,
                                    y: e,
                                    ctx: v,
                                    type: q.type,
                    ...
                    for (var w = 5 < n && r.bevelEnabled ? !0 : !1, f = 0; f < s.length; f++)
                        if (s[f].getTime ? p = s[f].x.getTime() : p = s[f].x, !(p < a.axisX.dataInfo.viewPortMin ||
                            ...
                            var u = g - n / 2 << 0,
                                ...
                                x = 0 === z % 2 ? 0 : 0.5,
                                y = r.dataPointIds[f];
                            this._eventManager.objectMap[y] = { id: y, objectType: "dataPoint", dataSeriesIndex: q, dataPointIndex: f, x1: u, y1: l, x2: v, y2: k, x3: g, y3: h, x4: g, y4: m, borderThickness: z, color: d };
                            c.strokeStyle = d;
                            c.beginPath();
                            c.lineWidth = z;
    ...
    B.prototype.renderRangeArea = function(a) {
        function c() { if (w) { var a = null;
                0 < h.lineThickness && b.stroke(); for (var c = l.length - 1; 0 <= c; c--) a = l[c], b.lineTo(a.x, a.y), d.lineTo(a.x, a.y);
                b.closePath();
                b.globalAlpha = h.fillOpacity;
                b.fill();
                b.globalAlpha = 1;
                d.fill(); if (0 < h.lineThickness) { b.beginPath();
                    b.moveTo(a.x, a.y); for (c = 0; c < l.length; c++) a = l[c], b.lineTo(a.x, a.y);
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (g = 0; g < a.dataSeriesIndexes.length; g++) {
                ...
                if (0 < m.length) {
                    ...
                    var x = "solid";
                    if (b.setLineDash) { var y = G(h.nullDataLineDashType, h.lineThickness),
                            x = h.lineDashType,
                    ...
                    for (var B = !0; n < m.length; n++)
                        if (s = m[n].x.getTime ? m[n].x.getTime() : m[n].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !B)))
                            if (null !== m[n].y && m[n].y.length && "number" === typeof m[n].y[0] && "number" === typeof m[n].y[1]) {
                                ...
                                p || B ? (h.connectNullData && !p ? (b.setLineDash && (h.options.nullDataLineDashType || x === h.lineDashType && h.lineDashType !== h.nullDataLineDashType) && (l[l.length - 1].newLineDashArray = A, x = h.nullDataLineDashType, b.setLineDash(y)), b.lineTo(e, q), t && d.lineTo(e, q), l.push({ x: e, y: r })) : (b.beginPath(), b.moveTo(e, q), w = { x: e, y: q }, l = [], l.push({ x: e, y: r }), t && (d.beginPath(), d.moveTo(e, q))), B = p = !1) : (b.lineTo(e, q), l.push({
                                    x: e,
                                    y: r
                                ...
                                if (0 !== m[n].markerSize && (0 < m[n].markerSize || 0 < h.markerSize)) { var C = h.getMarkerProperties(n, e, r, b);
                                    f.push(C); var V = F(s);
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (g = 0; g < a.dataSeriesIndexes.length; g++) {
                ...
                if (0 < h.length) {
                    ...
                    var v = "solid",
                        z;
                    if (b.setLineDash) { var x = G(k.nullDataLineDashType, k.lineThickness),
                            v = k.lineDashType;
                    ...
                    for (n = !1; m < h.length; m++)
                        if (p = h[m].x.getTime ? h[m].x.getTime() : h[m].x, !(p < a.axisX.dataInfo.viewPortMin || p > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !n)))
                            if (null !== h[m].y && h[m].y.length && "number" === typeof h[m].y[0] &&
                                ...
                                this._eventManager.objectMap[y] = { id: y, objectType: "dataPoint", dataSeriesIndex: l, dataPointIndex: m, x1: p, y1: n, y2: e };
                                q[q.length] = { x: p, y: n };
                                r[r.length] = { x: p, y: e };
                                ...
                                if (0 !== h[m].markerSize && (0 < h[m].markerSize || 0 < k.markerSize)) { var A = k.getMarkerProperties(m, p, n, b);
                                    f.push(A); var B = F(y);
    ...
    var Ga = function(a, c, b, d, f, g, l, k, h) {
        if (!(0 > b)) {
            ...
            if (!t) { var m = Number((l % (2 * Math.PI)).toFixed(8));
                Number((g % (2 * Math.PI)).toFixed(8)) === m && (l -= 1E-4) } a.save();
            a.globalAlpha = k;
    ...
    B.prototype.renderPie = function(a) {
        function c() {
            if (m && p) {
                for (var a = 0, b = 0, c = 0, d = 0, f = 0; f < p.length; f++) {
                    ...
                    l.midAngle = g;
                    if (l.midAngle > Math.PI / 2 - u && l.midAngle < Math.PI / 2 + u) { if (0 === a || q[c].midAngle > l.midAngle) c = f;
                        a++ } else if (l.midAngle > 3 * Math.PI / 2 - u && l.midAngle < 3 * Math.PI / 2 + u) { if (0 === b || q[d].midAngle > l.midAngle) d = f;
                        b++ } l.hemisphere = g > Math.PI / 2 && g <= 3 * Math.PI / 2 ? "left" : "right";
            ...
            for (b = 0; b < p.length; b++) {
                ...
                if (d > c) {
                    var f = 0.07 * C * Math.cos(q[b].midAngle),
                        ...
                        k = !1;
                    if (p[b].exploded) { if (1E-9 < Math.abs(q[b].center.x - (z.x + f)) || 1E-9 < Math.abs(q[b].center.y - (z.y + g))) q[b].center.x = z.x + f * a, q[b].center.y = z.y + g * a, k = !0 } else if (0 < Math.abs(q[b].center.x -
        ...
        function l() {
            ...
            for (var b = a = 0, c = 0, k = !0, b = 0; 10 > b && (1 > b || 0 < c); b++) {
                ...
                if ("inside" !== m.indexLabelPlacement) {
                    s = C * w;
                    for (a = 0; a < p.length; a++) { var l = q[a];
                ...
                var G = function(a, b, c) { for (var d = [], e = 0; d.push(q[b]), b !== c; b = (b + 1 + p.length) % p.length);
                    ...
                    for (var a = -1, b = -1, c = 0, e = !1, g = 0; g < p.length; g++)
                        if (e = !1, u = q[g], u.indexLabelText) {
                            ...
                            if (null !== h) {
                                ...
                                y = d(u, k);
                                var l;
                                if (l = 0 > y) { l = u.indexLabelTextBlock.x; var m = u.indexLabelTextBlock.y - u.indexLabelTextBlock.height / 2,
                                    ...
                                    l = u.indexLabelTextBlock.x + u.indexLabelTextBlock.width < k.indexLabelTextBlock.x - n || l > w + n || m > v + n || r < s - n ? !1 : !0 } l ? (0 > a && (a = g), h !== a && (b = h, c += -y), 0 === g % Math.max(p.length /
                                    10, 3) && (e = !0)) : e = !0;
        ...
        function k() {
            ...
            if (h.subtitles)
                for (var a = 0; a < h.subtitles.length; a++) { var b = h.subtitles[a];
                    (b.dockInsidePlotArea || "center" === b.horizontalAlign && "center" === b.verticalAlign) && b.render() } h.legend && (h.legend.dockInsidePlotArea || "center" === h.legend.horizontalAlign && "center" ===
            ...
            if (0 !== t) {
                ...
                this.pieDoughnutClickHandler = function(a) {
                    h.isAnimating || !y(a.dataSeries.explodeOnClick) &&
                        !a.dataSeries.explodeOnClick || (a = a.dataPoint, a.exploded = a.exploded ? !1 : !0, 1 < this.dataPoints.length && h._animator.animate(0, 500, function(a) { b(a);
                            k() }))
                };
                c();
                l();
                ...
                this._animator.animate(0, this.animatedRender ? this.animationDuration : 0, function(a) {
                    ...
                    k()
                }, function() { h.disableToolTip = !1;
                    h._animator.animate(0, h.animatedRender ? 500 : 0, function(a) { b(a);
                        k() }) })
            }
        }
    };
    ...
    B.prototype.exportChart =
        function(a) { a = "undefined" === typeof a ? {} : a; var c = a.format ? a.format : "png",
                b = a.fileName ? a.fileName : this.exportFileName; if (a.toDataURL) return this.canvas.toDataURL("image/" + c);
            Ba(this.canvas, c, b) };
    B.prototype.print = function() {
        ...
        setTimeout(function() { d.focus();
            d.print();
            setTimeout(function() { b._canvasJSContainer.removeChild(c) }, 1E3) }, 500)
    };
    ...
    ia.prototype.unRegisterSpace = function(a, c) { "top" === a ? this._topOccupied -= c.height : "bottom" === a ? this._bottomOccupied -= c.height : "left" === a ? this._leftOccupied -= c.width : "right" === a && (this._rightOccupied -= c.width) };
    ...
    ia.prototype.reset = function() { this._rightOccupied = this._leftOccupied = this._bottomOccupied = this._topOccupied = this._padding };
    S(U, L);
    ...
    U.prototype.setText = function(a) { this.text = a;
        this._isDirty = !0;
        this._wrappedText = null };
    ...
    U.prototype._getLineWithWidth = function(a, c, b) {
        ...
        var d = b = 0,
            f = a.length - 1,
            g = Infinity;
        for (this.ctx.font = this._getFontString(); d <= f;) { var g = Math.floor((d + f) / 2),
                l = a.substr(0, g + 1);
            b = this.ctx.measureText(l).width; if (b < c) d = g + 1;
            else if (b > c) f = g - 1;
            else break } b > c && 1 < l.length && (l = l.substr(0, l.length - 1), b = this.ctx.measureText(l).width);
        c = !0;
    ...
    U.prototype._wrapText = function() {
        ...
        if (0 === this.frontSize) f = d = 0;
            ...
            for (; 0 < a.length;) { var g = this.maxHeight - 2 * this.padding,
                ...
                g && d > g && (l = c.pop(), d -= l.height, f = k) } this._wrappedText = { lines: c, width: f, height: d };
        this.width = f + 2 * this.padding;
        this.height = d + 2 * this.padding;
        this.ctx.font = b
    };
    U.prototype._getFontString = function() { var a;
        a = "" + (this.fontStyle ? this.fontStyle + " " : "");
        a += this.fontWeight ? this.fontWeight + " " : "";
        a += this.fontSize ? this.fontSize + "px " : ""; var c = this.fontFamily ? this.fontFamily + "" : "";!t && c && (c = c.split(",")[0], "'" !== c[0] && '"' !== c[0] && (c = "'" + c + "'")); return a += c };
    S(ma, L);
                ...
                if ("pie" !== n.type && "doughnut" !== n.type && "funnel" !== n.type) {
                    ...
                    for (var v = 0; v < n.dataPoints.length; v++) {
                        var t = n.dataPoints[v],
                            ...
                            e = { markerType: e, markerColor: r, text: q, textBlock: null, chartType: n.type, markerSize: s, dataSeriesIndex: p, dataPointIndex: v, markerBorderColor: w, markerBorderThickness: u };
                ...
                if (!(0 >= l || "undefined" === typeof l || 0 >= q || "undefined" === typeof q)) {
                    if ("horizontal" === this.orientation) {
                        ...
                        if (!n || n.width + Math.round(e.textBlock.width + s + k + (0 === n.width ? 0 : this.horizontalSpacing) + ("line" === e.chartType || "spline" === e.chartType || "stepLine" ===
                                e.chartType ? 2 * 0.1 * this.lineHeight : 0)) > g) n = { items: [], width: 0 }, m.push(n), this.height += v, v = 0;
                        ...
                        (s + k + ("line" === e.chartType || "spline" === e.chartType || "stepLine" === e.chartType ? 2 * 0.1 * this.lineHeight : 0))), this.height < l - this.lineHeight ? (n = { items: [], width: 0 }, m.push(n)) : (n = m[t], t = (t + 1) % m.length), this.height += e.textBlock.height;
    ...
    $.prototype.getDataPointAtXY = function(a, c, b) {
        ...
        var d = [],
            ...
            p = 0,
            n = 0;
        "none" !== this.chart.plotInfo.axisPlacement && (n = (this.chart.axisX[0] ? this.chart.axisX[0] : this.chart.axisX2[0]).getXValueAt({ x: a, y: c }), this.axisX.logarithmic ? (g = Math.log(this.dataPoints[this.dataPoints.length - 1].x / this.dataPoints[0].x), n = 1 < g ? Math.min(Math.max((this.dataPoints.length - 1) / g * Math.log(n / this.dataPoints[0].x) >> 0, 0), this.dataPoints.length) : 0) : (g = this.dataPoints[this.dataPoints.length - 1].x - this.dataPoints[0].x, n = 0 < g ? Math.min(Math.max((this.dataPoints.length - 1) /
                ...
                if (e) {
                    switch (this.type) {
                        ...
                        case "bubble":
                            s = e.size;
                            r = Math.sqrt(Math.pow(e.x1 - a, 2) + Math.pow(e.y1 - c, 2));
                            r <= s / 2 && (d.push({ dataPoint: q, dataPointIndex: g, dataSeries: this, distance: r }), k = !0);
                            break;
                        case "pie":
                        case "doughnut":
                            s = e.center;
    ...
    C.prototype.createExtraLabelsForLog = function(a) {
        a =
            (a || 0) + 1;
        if (!(5 < a)) { var c = this.logLabelValues[0] || this.intervalStartPosition; if (Math.log(this.range) / Math.log(c / this.viewportMinimum) < this.noTicks - 1) { for (var b = C.getNiceNumber((c - this.viewportMinimum) / Math.min(Math.max(2, this.noTicks - this.logLabelValues.length), 3), !0), d = Math.ceil(this.viewportMinimum / b) * b; d < c; d += b) d < this.viewportMinimum || this.logLabelValues.push(d);
    ...
    C.prototype.createLabels = function() {
        ...
        if ("axisX" === this.type && b && !this.logarithmic)
            ...
            if (this.labels) { a = Math.ceil(k); for (var k = Math.ceil(this.intervalStartPosition), n = !1, b = k; b < this.viewportMaximum; b += a)
        ...
        for (d = 0; d < this._labels.length; d++) { a = this._labels[d].textBlock;
            a.maxWidth = g;
            a.maxHeight = l; var q = a.measureText();
            m = q.height } f = [];
        n = k = 0;
    ...
    C.prototype.createLabelsAndCalculateWidth = function() {
        ...
        if ("left" === this._position || "right" === this._position) {
            this.createLabels();
            for (c = 0; c < this._labels.length; c++) { var b = this._labels[c].textBlock,
                    d = b.measureText(),
                    f = 0,
    ...
    C.prototype.createLabelsAndCalculateHeight = function() {
        ...
        if ("bottom" === this._position || "top" === this._position) {
            for (b = 0; b < this._labels.length; b++) { c = this._labels[b].textBlock; var d = c.measureText(),
                    f = 0,
            ...
            for (; 4 > q;) {
                ...
                if (b &&
                    ...
                    for (e = 0; e < b.length; e++) D = 10, b[e] && (l = Math.round(a[0] ? a[0].lineCoordinates.x1 : c[0].lineCoordinates.x1), D = b[e]._labels && 0 < b[e]._labels.length ? b[e]._labels[b[e]._labels.length - 1].textBlock.height / 2 : 10, k = Math.round(g.y1 + T + K < Math.max(D, 10) ? Math.max(D, 10) : g.y1 + T + K), h = Math.round(a[0] ? a[0].lineCoordinates.x1 : c[0].lineCoordinates.x1), D = 0 < a.length ? 0 : b[e]._labels && 0 < b[e]._labels.length ? b[e]._labels[0].textBlock.height / 2 : 10, m = Math.round(g.y2 - X - f - D), b[e].lineCoordinates = {
                        ...
                        height: Math.abs(m -
                            k)
                    }, b[e].bounds = { x1: l - (v[e] + N), y1: k, x2: h, y2: m, width: h - l, height: m - k }, b[e].title && (b[e]._titleTextBlock.maxWidth = 0 < b[e].titleMaxWidth && b[e].titleMaxWidth < b[e].lineCoordinates.height ? b[e].titleMaxWidth : b[e].lineCoordinates.height), N += v[e] + b[e].margin);
                if (d && 0 < d.length)
                    for (e = 0; e < d.length; e++) d[e] && (l = Math.round(a[0] ? a[0].lineCoordinates.x2 : c[0].lineCoordinates.x2), h = Math.round(l), D = d[e]._labels && 0 < d[e]._labels.length ? d[e]._labels[d[e]._labels.length - 1].textBlock.height / 2 : 0, k = Math.round(g.y1 + T + K < Math.max(D,
                        10) ? Math.max(D, 10) : g.y1 + T + K), D = 0 < a.length ? 0 : d[e]._labels && 0 < d[e]._labels.length ? d[e]._labels[0].textBlock.height / 2 : 0, m = Math.round(g.y2 - (X + f + D)), d[e].lineCoordinates = { x1: l + O, y1: k, x2: l + O, y2: m, height: Math.abs(m - k) }, d[e].bounds = { x1: l, y1: k, x2: h + (z[e] + O), y2: m, width: h - l, height: m - k }, d[e].title && (d[e]._titleTextBlock.maxWidth = 0 < d[e].titleMaxWidth && d[e].titleMaxWidth < d[e].lineCoordinates.height ? d[e].titleMaxWidth : d[e].lineCoordinates.height), O += z[e] + d[e].margin);
                if (a && 0 < a.length)
                    for (e = 0; e < a.length; e++) a[e] &&
            ...
            for (; 4 > q;) {
                ...
                if (b && 0 < b.length)
                    for (e = b.length - 1; 0 <= e; e--) k = Math.round(g.y2), m = Math.round(g.y2 > b[e].chart.height - 10 ? b[e].chart.height - 10 : g.y2), b[e].lineCoordinates.y1 = k - (x[e] + b[e].margin + M), b[e].lineCoordinates.y2 = k - (x[e] + b[e].margin +
                        M), b[e].bounds = { x1: l, y1: k - (x[e] + M + b[e].margin), x2: h, y2: m - (M + b[e].margin), width: h - l, height: x[e] }, b[e].title && (b[e]._titleTextBlock.maxWidth = 0 < b[e].titleMaxWidth && b[e].titleMaxWidth < b[e].lineCoordinates.width ? b[e].titleMaxWidth : b[e].lineCoordinates.width), M += x[e] + b[e].margin;
                if (d && 0 < d.length)
                    for (e = d.length - 1; 0 <= e; e--) d[e] && (k = Math.round(g.y1), m = Math.round(g.y1 + (A[e] + d[e].margin + P)), d[e].lineCoordinates.y1 = m, d[e].lineCoordinates.y2 = m, d[e].bounds = { x1: l, y1: k + (d[e].margin + P), x2: h, y2: m, width: h - l, height: S },
                ...
                if (a && 0 < a.length)
                    for (e = 0; e < a.length; e++) {
                        ...
                        a[e].bounds = { x1: h - (B[e] + J), y1: k, x2: h, y2: m, width: h - l, height: m - k };
        ...
        if ("undefined" === typeof this.options.interval) {
            if ("bottom" === this._position || "top" === this._position)
                if (this.logarithmic &&
                    ...
                    this._labels = c
                } else { for (h = 0; h < this._labels.length; h++) p = this._labels[h], p.position < this.viewportMinimum || (p = p.textBlock.width * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + p.textBlock.height * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)), c += p);
            ...
            if ("left" === this._position || "right" === this._position)
                if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
                    for (var c = [], m, l = this.viewportMaximum, k = this.lineCoordinates.height /
                            Math.log(this.range), h = this._labels.length - 1; 0 <= h; h--) { p = this._labels[h]; if (p.position < this.viewportMinimum) break;
                        p.position > this.viewportMaximum || !(h === this._labels.length - 1 || m < Math.log(l / p.position) * k) || (c.push(p), l = p.position, m = p.textBlock.height * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + p.textBlock.width * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle))) } this._labels = c
                } else {
    ...
    C.prototype.renderStripLinesOfThicknessType = function(a) {
        if (this.stripLines && 0 < this.stripLines.length && a) {
                ...
                if (m = this.stripLines[d], b = this._stripLineLabels[d], !(b.position < this.viewportMinimum || b.position > this.viewportMaximum || isNaN(this.range))) {
                    ...
                    if ("outside" === b.stripLine.labelPlacement)
                        if (m && (this.ctx.strokeStyle = m.color, "pixel" === m._thicknessType && (this.ctx.lineWidth = m.thickness)),
                            "bottom" === this._position) { var p = 1 === this.ctx.lineWidth % 2 ? (a.x << 0) + 0.5 : a.x << 0;
                            this.ctx.beginPath();
                            this.ctx.moveTo(p, a.y << 0);
                            this.ctx.lineTo(p, a.y + this.tickLength << 0);
                            this.ctx.stroke();
                            0 === this.labelAngle ? (a.x -= b.textBlock.width / 2, a.y += this.tickLength + b.textBlock.fontSize / 2) : (a.x -= 0 > this.labelAngle ? b.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) : 0, a.y += this.tickLength + Math.abs(0 > this.labelAngle ? b.textBlock.width * Math.sin(Math.PI / 180 * this.labelAngle) - 5 : 5)) } else "top" === this._position ? (p = 1 ===
            ...
            if (!l) {
                ...
                for (d = 0; d < h.length; d++) b = h[d], b.stripLine.showOnTop ? l || (l = !0, this.chart.addEventListener("dataAnimationIterationEnd", function() { for (f = 0; f < h.length; f++) b = h[f], "inside" === b.stripLine.labelPlacement && b.stripLine.showOnTop && (c.ctx.save(), c.ctx.beginPath(), c.ctx.rect(c.chart.plotArea.x1, c.chart.plotArea.y1, c.chart.plotArea.width, c.chart.plotArea.height), c.ctx.clip(), b.textBlock.render(!0), c.ctx.restore()) }, b.textBlock)) :
                    "inside" === b.stripLine.labelPlacement && b.textBlock.render(!0);
                this.ctx.restore();
                l = !0
            }
            if (l)
                for (l = !1, d = 0; d < h.length; d++) b = h[d], b.stripLine.showOnTop ? l || (l = !0, this.chart.addEventListener("dataAnimationIterationEnd", function() { for (f = 0; f < h.length; f++) b = h[f], "outside" === b.stripLine.labelPlacement && b.stripLine.showOnTop && b.textBlock.render(!0) }, b.textBlock)) : "outside" === b.stripLine.labelPlacement && b.textBlock.render(!0)
        }
    };
    ...
    C.prototype.convertPixelToValue = function(a) { if ("undefined" === typeof a) return null; var c = 0,
            c = 0,
            c = "number" === typeof a ? a : "left" === this._position || "right" === this._position ? a.y : a.x; return c = this.logarithmic ? Math.pow(this.logarithmBase, (c - this.conversionParameters.reference) / this.conversionParameters.pixelPerUnit) * this.viewportMinimum : this.conversionParameters.minimum + (c - this.conversionParameters.reference) / this.conversionParameters.pixelPerUnit };
    ...
    C.prototype.setViewPortRange = function(a, c) { this.sessionVariables.newViewportMinimum = this.viewportMinimum = Math.min(a, c);
        this.sessionVariables.newViewportMaximum = this.viewportMaximum = Math.max(a, c) };
    C.prototype.getXValueAt =
        function(a) { if (!a) return null; var c = null; "left" === this._position ? c = this.convertPixelToValue(a.y) : "bottom" === this._position && (c = this.convertPixelToValue(a.x)); return c };
    ...
    C.prototype.calculateLogarithamicAxisParameters = function() {
        ...
        if (!this.options.interval &&
            this.range < Math.pow(this.logarithmBase, 8 > this.viewportMaximum || 3 > a ? 2 : 3)) { for (c = Math.floor(this.viewportMinimum / b + 0.5) * b; c < this.viewportMinimum;) c += b;
            this.equidistantInterval = !1;
            this.intervalStartPosition = c;
            this.interval = b } else this.options.interval || (b = Math.ceil(this.interval), this.range > this.interval && (this.interval = b, d = Math.pow(this.logarithmBase, Math.floor(Math.log(this.viewportMinimum) / (c * this.interval) + 0.2) * this.interval))), this.equidistantInterval = !0, this.intervalStartPosition = d;
        if (!this.valueFormatString &&
            (this.valueFormatString = "#,##0.##", 1 > this.viewportMinimum)) { c = Math.floor(Math.abs(Math.log(this.viewportMinimum) / Math.LN10)) + 2; if (isNaN(c) || !isFinite(c)) c = 2; if (2 < c)
                for (b = 0; b < c - 2; b++) this.valueFormatString += "#" }
    };
    C.getNiceExponent = function(a, c) { var b = Math.floor(Math.log(a) / Math.LN10),
            d = a / Math.pow(10, b),
            d = 0 > b ? 1 >= d ? 1 : 5 >= d ? 5 : 10 : Math.max(Math.floor(d), 1); return Number((d * Math.pow(10, b)).toFixed(20)) };
    ...
    C.prototype.getLabelStartPoint = function() {
        ...
        if ("millisecond" !== this.intervalType)
            ...
            else if ("minute" === this.intervalType) { if (0 < a.getSeconds() || 0 < a.getMilliseconds()) a.setMinutes(a.getMinutes() + 1), a.setSeconds(0), a.setMilliseconds(0) } else if ("hour" ===
    ...
    S(na, L);
    na.prototype.createUserOptions = function(a) { if ("undefined" !== typeof a || this.options._isPlaceholder) { var c = 0;
    ...
    na.prototype.render = function() {
        ...
        if (0 < c) {
            ...
            if ("bottom" === this.parent._position || "top" === this.parent._position) f =
                g = 1 === this.ctx.lineWidth % 2 ? (a.x << 0) + 0.5 : a.x << 0, l = this.chart.plotArea.y1, k = this.chart.plotArea.y2, this.bounds = { x1: f - c / 2, y1: l, x2: g + c / 2, y2: k };
            else if ("left" === this.parent._position || "right" === this.parent._position) l = k = 1 === this.ctx.lineWidth % 2 ? (a.y << 0) + 0.5 : a.y << 0, f = this.chart.plotArea.x1, g = this.chart.plotArea.x2, this.bounds = { x1: f, y1: l - c / 2, x2: g, y2: k + c / 2 };
            this.ctx.moveTo(f, l);
            this.ctx.lineTo(g, k);
            this.ctx.stroke();
    ...
    Q.prototype._updateToolTip = function(a, c, b) {
        ...
        if (!this.chart.disableToolTip) {
            if ("undefined" === typeof a || "undefined" === typeof c) { if (isNaN(this._prevX) || isNaN(this._prevY)) return;
                a = this._prevX;
                c = this._prevY } else this._prevX = a, this._prevY = c;
            var d = null,
                f = null,
                g = [],
                l = 0;
            if (this.shared && this.enabled && "none" !== this.chart.plotInfo.axisPlacement) {
                if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                    ...
                    if (this.chart.axisX)
                        for (var k =
                                0; k < this.chart.axisX.length; k++) { for (var l = this.chart.axisX[k].convertPixelToValue({ y: c }), h = null, d = 0; d < this.chart.axisX[k].dataSeries.length; d++)(h = this.chart.axisX[k].dataSeries[d].getDataPointAtX(l, b)) && 0 <= h.index && (h.dataSeries = this.chart.axisX[k].dataSeries[d], null !== h.dataPoint.y && f.push(h));
                            h = null }
                    ...
                    if (this.chart.axisX)
                        for (k = 0; k < this.chart.axisX.length; k++)
                            for (l = this.chart.axisX[k].convertPixelToValue({ x: a }), h = null, d = 0; d < this.chart.axisX[k].dataSeries.length; d++)(h = this.chart.axisX[k].dataSeries[d].getDataPointAtX(l, b)) && 0 <= h.index && (h.dataSeries = this.chart.axisX[k].dataSeries[d], null !== h.dataPoint.y && f.push(h));
                    if (this.chart.axisX2)
                        for (k = 0; k < this.chart.axisX2.length; k++)
                            for (l =
                ...
                if (h = this.chart.getDataPointAtXY(a, c, b)) this.currentDataPointIndex =
                    ...
                    if (h = Ma(a, c, this.chart._eventManager.ghostCtx), 0 < h && "undefined" !== typeof this.chart._eventManager.objectMap[h]) { h = this.chart._eventManager.objectMap[h]; if ("legendItem" === h.objectType) return;
                        this.currentSeriesIndex = h.dataSeriesIndex;
                        this.currentDataPointIndex = 0 <= h.dataPointIndex ? h.dataPointIndex : -1 } else this.currentDataPointIndex = -1;
                ...
                if (0 <= this.currentSeriesIndex) {
                    ...
                    if (!y(h.dataPoint.y))
                        if (h.dataSeries.axisY)
                            if (0 < h.dataPoint.y.length) { for (d = b = 0; d < h.dataPoint.y.length; d++) h.dataPoint.y[d] < h.dataSeries.axisY.viewportMinimum ? b-- : h.dataPoint.y[d] > h.dataSeries.axisY.viewportMaximum && b++;
                                b < h.dataPoint.y.length && b > -h.dataPoint.y.length && g.push(h) } else "column" === f.type || "bar" === f.type ? 0 > h.dataPoint.y ? 0 > h.dataSeries.axisY.viewportMinimum && h.dataSeries.axisY.viewportMaximum >= h.dataPoint.y && g.push(h) : h.dataSeries.axisY.viewportMinimum <=
    ...
    Q.prototype.getToolTipInnerHTML = function(a) {
        ...
        for (var c = null, b = null, d = null, f = 0, g = "", l = !0, k = 0; k < a.length; k++)
            if (a[k].dataSeries.toolTipContent || a[k].dataPoint.toolTipContent) { l = !1; break }
        if (l && (this.content && "function" === typeof this.content ||
                this.contentFormatter)) a = { chart: this.chart, toolTip: this.options, entries: a }, c = this.contentFormatter ? this.contentFormatter(a) : this.content(a);
    ...
    Q.prototype.show = function(a, c, b) { this._updateToolTip(a, c, "undefined" === typeof b ? !1 : b) };
    ...
    B.prototype.replaceKeywordsWithValue = function(a, c, b, d, f) {
        ...
        return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g, function(a) {
            ...
            a = a.replace("#index",
                f);
            var e = null;
            try { var h = a.match(/(.*?)\s*\[\s*(.*?)\s*\]/);
                h && 0 < h.length && (e = ka(h[2]), a = ka(h[1])) } catch (k) {} h = null;
    ...
    la.prototype.reset = function() { this.lastObjectId = 0;
        this.objectMap = [];
        this.rectangularRegionEventSubscriptions = [];
        this.previousDataPointEventObject = null;
        this.eventObjects = [];
        t && (this.ghostCtx.clearRect(0, 0, this.chart.width, this.chart.height), this.ghostCtx.beginPath()) };
    la.prototype.getNewObjectTrackingId = function() { return ++this.lastObjectId };
    la.prototype.mouseEventHandler = function(a) {
        if ("mousemove" === a.type || "click" === a.type) {
            ...
            if ((d = this.chart.getObjectAtXY(b.x, b.y, !1)) && "undefined" !== typeof this.objectMap[d])
                if (d = this.objectMap[d], "dataPoint" === d.objectType) {
                    var f = this.chart.data[d.dataSeriesIndex],
                        ...
                        l = d.dataPointIndex;
                    d.eventParameter = { x: b.x, y: b.y, dataPoint: g, dataSeries: f.options, dataPointIndex: l, dataSeriesIndex: f.index, chart: this.chart };
                    d.eventContext = {
                        context: g,
                        userContext: g,
                        mouseover: "mouseover",
                    ...
                    d.eventParameter = { x: b.x, y: b.y, dataPoint: g, dataSeries: f.options, dataPointIndex: l, dataSeriesIndex: f.index, chart: this.chart };
                    d.eventContext = { context: f, userContext: f.options, mouseover: "mouseover", mousemove: "mousemove", mouseout: "mouseout", click: "click" };
            ...
            for (b = 0; b < c.length; b++) { f = !1; for (d = 0; d < this.mouseoveredObjectMaps.length; d++)
                    if (c[b].id === this.mouseoveredObjectMaps[d].id) { f = !0; break }
                f || (this.fireEvent(c[b], "mouseover", a), this.mouseoveredObjectMaps.push(c[b])); "click" === a.type ? this.fireEvent(c[b], "click", a) : "mousemove" === a.type && this.fireEvent(c[b], "mousemove", a) }
        }
    };
    ...
    Da.prototype.cancelAllAnimations = function() { this.animations = [];
        this.animationRequestId && this.chart.cancelRequestAnimFrame.call(window, this.animationRequestId);
        this.animationRequestId = null;
        this.chart.isAnimating = !1 };
    var E = {
            yScaleAnimation: function(a, c) { if (0 !== a) { var b = c.dest,
                        d = c.source.canvas,
                        f = c.animationBase;
            ...
            xClipAnimation: function(a, c) { if (0 !== a) { var b = c.dest,
                        d = c.source.canvas;
                    b.save();
                    0 < a && b.drawImage(d, 0, 0, d.width * a, d.height, 0, 0, d.width * a / P, d.height / P);
                    b.restore() } },
            fadeInAnimation: function(a, c) { if (0 !== a) { var b = c.dest,
                        d = c.source.canvas;
                    b.save();
                    b.globalAlpha = a;
                    ...
                    b.restore() } },
            easing: {
                linear: function(a, c, b, d) { return b * a / d + c },
                easeOutQuad: function(a, c, b, d) {
                    return -b *
                        (a /= d) * (a - 2) + c
                },
                easeOutQuart: function(a, c, b, d) { return -b * ((a = a / d - 1) * a * a * a - 1) + c },
                easeInQuad: function(a, c, b, d) { return b * (a /= d) * a + c },
                easeInQuart: function(a, c, b, d) { return b * (a /= d) * a * a * a + c }
            }
        },
        N = {
            ...
            drawMarkers: function(a) { for (var c = 0; c < a.length; c++) { var b = a[c];
                    N.drawMarker(b.x, b.y, b.ctx, b.type, b.size, b.color, b.borderColor, b.borderThickness) } }
        },
        ja = {
            Chart: B,
            addColorSet: function(a, c) { ga[a] = c },
            addCultureInfo: function(a, c) { pa[a] = c },
            formatNumber: function(a, c, b) { b = b || "en"; if (pa[b]) return ca(a, c || "#,##0.##", new oa(b)); throw "Unknown Culture Name"; },
...
document.createElement("canvas").getContext || function() {
    ...
    function T(a, b, c, g) {
        ...
        if (e instanceof w) {
            ...
            for (var n = [], r = 0; r < d; r++) { var t = f[r];
                n.push(t.offset * m + u + " " + t.color) } b.push('<g_vml_:fill type="', e.type_, '"', ' method="none" focus="100%"', ' color="', p, '"', ' color2="', c, '"', ' colors="', n.join(","), '"', ' opacity="', a, '"', ' g_o_:opacity2="', k, '"', ' angle="', h, '"', ' focusposition="', g, ",", l, '" />')
        } else e instanceof
    ...
    function I(a, b) { if (!a || 1 != a.nodeType || "IMG" != a.tagName) throw new A("TYPE_MISMATCH_ERR"); if ("complete" != a.readyState) throw new A("INVALID_STATE_ERR"); switch (b) {
            ...
            default:
                throw new A("SYNTAX_ERR"); } this.src_ = a.src;
        this.width_ = a.width;
    ...
    d.drawText_ = function(a, b, c, d, e) {
        ...
        h = this.font;
        if (L[h]) h = L[h];
        else { var l = document.createElement("div").style; try { l.font = h } catch (u) {} h = L[h] = { style: l.fontStyle || "normal", variant: l.fontVariant || "normal", weight: l.fontWeight || "normal", size: l.fontSize || 10, family: l.fontFamily || "sans-serif" } }
        var l = h,
            m = this.element_;
        h = {};
